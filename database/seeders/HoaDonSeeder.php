    ...
    public function run()
    {
        ...
        for ($i = 1; $i < 100; $i++) {
            ...
            DB::table('hoadon')->insert([
                ['id'=>$i,'idkhachhang' => rand(1, 6), 'idcoso'=> 1, 'idnhanvien'=> rand(1, 6), 'idthungan' => rand(1, 6), 'idlieutrinh'=> rand(1, 7), 'idgiamgia'=> 1, 'tongtientruocgiamgia' => $tongTienTruocGiam, 'tongtiensaugiamgia' => $tongTienSauGiam, 'trangthai' => 1, 'created_at'=>$randomDay],
            ]);
