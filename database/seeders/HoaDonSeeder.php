...
class HoaDonSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for ($i = 1; $i < 1000; $i++) {
            ...
            DB::table('hoadon')->insert([
                ['id'=>$i,'idkhachhang' => rand(1, 6), 'idcoso'=> 1, 'idnhanvien'=> rand(1, 6), 'idthungan' => rand(1, 6), 'idlieutrinh'=> 1, 'idgiamgia'=> 1, 'tongtientruocgiamgia' => $tongTienTruocGiam, 'tongtiensaugiamgia' => $tongTienSauGiam, 'trangthai' => 1, 'created_at'=>$randomDay],
            ]);
            DB::table('hoadonchitiet')->insert([
