                ...
                <div class="tab-content" id="myTabContent-1">
                    <div class="tab-pane fade show active" id="tatca" role="tabpanel">
                        ...
                        <div class="w-100">
                            ...
                            <a id="xemthembtndv">
                                <button class="w-25 border border-dark p-2" style="background-color: #e87c7b;"  onclick="xemThemDichVu()">Xem thêm <i class="fa fa-angle-down"></i></button>
                            </a>
                        </div>
                        <hr>
                        ...
                        <div class="w-100">
                            ...
                            <a id="xemthembtnsp">
                                <button class="w-25 border border-dark p-2" style="background-color: #e87c7b;"  onclick="xemThemSanPham()">Xem thêm <i class="fa fa-angle-down"></i></button>
                            </a>
                        ...
                        <div class="w-100">
                            ...
                            <a id="xemthembtnbv">
                                <button class="w-25 border border-dark p-2" style="background-color: #e87c7b;"  onclick="xemThemBaiViet()">Xem thêm <i class="fa fa-angle-down"></i></button>
                            </a>
                        </div>
