                                        ...
                                        <div class="d-flex">
                                            ...
                                            <ul class="nav nav-tabs" id="myTab-1" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <a class="nav-link btn-3 active" id="new-tab" data-toggle="tab"
                                                       href="#new" role="tab" aria-controls="new" aria-selected="true">Mới
                                                        nhất</a>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                            ...
                                            <div class="col-xl-6 pr-0">
                                                <div class="blog-bigsize">
                                                    <div class="box-danhmuc">
                                                        <a class="text-white"
                                                           href="{{ asset('danh-muc-bai-viet') }}/{{$blog[0]->slugdm}}">
                                                            {{$blog[0]->danhmuc}}</a>
                                                    </div>
                                                                ...
                                                                <div class="col-xl-7 pl-0 align-self-center">
                                                                    <div class="row">
                                                                        <div
                                                                            ...
                                                                            <div class="mr-3">
                                                                                <a href="{{ asset('danh-muc-bai-viet') }}/{{$item->slugdm}}"
                                                                                   class="box-danhmuc-1">
                                                                                    {{$item->danhmuc}} </a>
                                                                            </div>
                                                                            <div class="formatDayCustom"
                                                                                 data-type="short"
                                            ...
                                            @foreach ($blog3 as $item1)
                                                <div class="col-xl-6 pr-0">
                                                    <div class="blog-bigsize">
                                                        <div class="box-danhmuc">
                                                            <a class="text-white"
                                                               href="{{ asset('danh-muc-bai-viet') }}/{{$item1->slugdm}}">
                                                                {{$item1->danhmuc}}</a>
                                                        </div>
                                                        ...
                                                        <div class="blog-content-bigsize">
                                                            ...
                                                            <div class="blog-text-2 mt-2 formatDayCustom"
                                                                 data-type="long" data-format="{{$item1->created_at}}">
                                                                <?php
                                                ...
                                                <div class="content-tin background-none pt-4 p-0">
                                                    <div class="row">
                                                        <div
                                                            ...
                                                            <div class="div formatDayCustom" data-type="short"
                                                                 data-format="{{$blognewtt[0]->created_at}}">
                                                    ...
                                                    <div class="text-bl-1 limit-text-row-1 mb-2 mt-3">
                                                        <a href="{{ asset('bai-viet') }}/{{$item->slug}}"
                                                           class="hover-pink color-white fz-1em font-weight-600">{{$item->name}}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            @foreach ($listdanhmuc as $item)
                                ...
                                @if (count($item->blogbyid) > 0 )
                                    ...
                                    @if (count($item->blogbyid) == 6)
                                        <a href="{{ asset('danh-muc-bai-viet') }}/{{$item->slug}}">
                                            <button type="button" class="xemthemblog btn mb-5 mt-3" data-take="3"
                                                    data-skip="6">Xem thêm
                                            </button>
                                        </a>
                                    @else
                                        <br> <br>
                                    ...
                                    <div class="small-blog-item box-tin-hv">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7 pl-0 align-self-center">
                                                <div class="row">
                                                    <div
                                                        class="col-xl-12 d-flex align-items-center color-gray-2 hover-color-black text-small-1 formatDayCustom"
                                                        data-type="short" data-format="{{$data->created_at}}">
                                                <span>
                                                    @if ($data->created_at != null)
                                                        <?php
                                                        $timestamp = strtotime($data->created_at);
