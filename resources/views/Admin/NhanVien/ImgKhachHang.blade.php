                                            ...
                                            <div class="gal-detail thumb position-relative showdel">
                                                <a href="{{asset('uploads/khachhang')}}/{{ $ns}}" class="image-popup" title="Screenshot-1">
                                                    <img src="{{asset('uploads/khachhang')}}/{{ $ns}}"
                                                         ...
                                                         alt="work-thumbnail">
                                                    <a href="{{URL::to("quantri/nhanvien/xoaImgKH", auth()->user()->id)}}/phantu/{{$id}}" class="p-1 bg-primary rounded position-absolute btnxoa" style="right: 7%; top: 7%;"  data-toggle="tooltip" data-placement="top" title="Xóa"><i class="fa fa-trash text-white"></i></a>
                                                </a>
                                            </div>
                                        </div>
                                    @endforeach
