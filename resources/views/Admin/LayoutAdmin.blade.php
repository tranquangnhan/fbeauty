...
<html lang="en">
    ...
    <body>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{url('quantri/coso/create')}}"> Thêm Mới </a></li>
                                    <li><a href="{{url('quantri/coso')}}"> Danh Sách </a></li>
                                </ul>
                            </li>
        ...
        <!-- <script src="{{ asset('Admin/assets') }}/js/coso.js"></script> -->
        <script>
