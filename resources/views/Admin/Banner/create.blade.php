                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            @endif
                            <form action="{{route('banner.store')}}" id="ktform" enctype="multipart/form-data"
                                  method="post">
                                @csrf
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <label class="w-100" for="anhien">Ẩn hiện:(<span
                                                    ...
                                                    <select class="form-control select2" name="anhien">
                                                        <option value="<?php echo App\Http\Controllers\Controller::BANNER_HIEN?>">Hiện</option>
                                                        <option value="<?php echo App\Http\Controllers\Controller::BANNER_AN?>">Ẩn</option>
                                                    </select>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 m-auto">
                                                <div id="image" class="w-50 m-auto" ></div>
                                            </div>
                                        </div>
                                    <div class="row mt-2">
                                        <div class="col-md-12">
    ...
    <script>
        ...
        $("#ktform").validate({
            ...
            messages: {
                ...
                files:{
                    required: "<span class='badge badge-danger'>Mời cập nhật hình ảnh </span>"
                }
            }
        });
    </script>
