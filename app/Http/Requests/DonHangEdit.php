...
class DonHangEdit extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'ghichukhachhang' => ['required', 'max:150'],
    ...
    public function messages() {
        return [
            ...
            'tongtientruocgiamgia.min' => 'Tổng tiền phải lớn hơn 4 kí tự',
            'tongtiensaugiamgia.required' => 'Bạn chưa nhập tổng tiền sau khi giảm',
            'tongtientruocgiamgia.min' => 'Tổng tiền phải lớn hơn 4 kí tự',
            'ghichukhachhang.required' => 'Bạn chưa nhập ghi chú khách',
            'ghichukhachhang.max' => 'ghi chú tối đa 150 kí tự',
